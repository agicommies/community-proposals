...
export default function ProposalDetails(props: TProposalDetails) {
  ...
  const favorablePercentage =
    (votesFavorable * 100) / (votesAgainst + votesFavorable);
              ...
              <Card.Root>
                ...
                <Card.Body className="flex flex-col space-y-4">
                  ...
                  <span className="flex items-center text-sm">
                    ...
                    <span className="ml-1 text-xs text-gray-600">| URL</span>
                  </span>
                ...
                <Card.Body>
                  <div className="flex justify-between">
                    ...
                    <div className="flex items-center gap-2 divide-x">
                      <span className="text-xs">{votesFavorable} COMAI</span>
                  ...
                  <div className="my-2 w-full rounded-3xl bg-[#212D43]">
                    <div
                      ...
                      style={{ width: `${favorablePercentage.toFixed(0)}%` }}
                    />
                  </div>
                  ...
                  <div className="my-2 w-full rounded-3xl bg-[#212D43]">
                    <div
                      ...
                      style={{ width: `${againstPercentage.toFixed(0)}%` }}
                    />
                  </div>
                </Card.Body>
              </Card.Root>
