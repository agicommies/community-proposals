...
export function Header() {
  ...
  return (
    <>
      ...
      <header className="dark:bg-light-dark sticky top-0 z-40 flex w-full flex-wrap items-center justify-between bg-white p-4 shadow-md">
        ...
        <>
          <div className="hidden w-full flex-grow items-center md:w-auto lg:block">
            <div className="flex gap-3 xl:gap-6">
              <div className="relative text-lg font-medium dark:text-white">
                Community Proposals
              </div>
            </div>
          </div>
          ...
          <div className="col-span-3 ml-auto self-center md:hidden">
            <button
              type="button"
              onClick={toggleMobileMenu}
              className="dark:bg-dark flex h-12 w-12 items-center justify-center rounded-lg"
            >
